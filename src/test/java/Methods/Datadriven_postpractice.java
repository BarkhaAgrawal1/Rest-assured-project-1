...
public class Datadriven_postpractice {

    @Test(dataProvider="postddt")
    public void Post(String nameValue, String salaryvalue,String agevalue) {

        JSONObject obj = new JSONObject();
        obj.put("name", nameValue);
        obj.put("salary", salaryvalue);
    ...
    String[][] getdata() throws IOException {
        String path = "C:\\Users\\deepa\\Documents\\Barkha new intellij\\RestAssuredproject1\\src\\test\\Resources\\TestDemo.xlsx";
